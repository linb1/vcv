...
const Overlay = () => {
  return (
    <div className="fixed h-screen w-1/5 min-w-60 bg-white shadow-md border border-slate-300">
      <div className="flex flex-col justify-center items-center gap-10 px-5 py-14 h-full overflow-scroll">
        ...
        <div>
          ...
          <ul className="list-disc px-5 text-sm">
            ...
            <li>Delete a node and all descendants using the modal</li>
          </ul>
        </div>
      </div>
    </div>
